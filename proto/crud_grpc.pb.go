...
const (
	...
	CRUD_Read_FullMethodName   = "/CRUD.CRUD/Read"
...
type CRUDClient interface {
	Create(ctx context.Context, in *UserWriteReq, opts ...grpc.CallOption) (*DatabaseResp, error)
	Read(ctx context.Context, in *UserReadReq, opts ...grpc.CallOption) (*DatabaseResp, error)
	Update(ctx context.Context, in *UserWriteReq, opts ...grpc.CallOption) (*DatabaseResp, error)
	Delete(ctx context.Context, in *UserReadReq, opts ...grpc.CallOption) (*DatabaseResp, error)
}
...
func (c *cRUDClient) Create(ctx context.Context, in *UserWriteReq, opts ...grpc.CallOption) (*DatabaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DatabaseResp)
...
func (c *cRUDClient) Read(ctx context.Context, in *UserReadReq, opts ...grpc.CallOption) (*DatabaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DatabaseResp)
...
func (c *cRUDClient) Update(ctx context.Context, in *UserWriteReq, opts ...grpc.CallOption) (*DatabaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DatabaseResp)
...
func (c *cRUDClient) Delete(ctx context.Context, in *UserReadReq, opts ...grpc.CallOption) (*DatabaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DatabaseResp)
...
type CRUDServer interface {
	Create(context.Context, *UserWriteReq) (*DatabaseResp, error)
	Read(context.Context, *UserReadReq) (*DatabaseResp, error)
	Update(context.Context, *UserWriteReq) (*DatabaseResp, error)
	Delete(context.Context, *UserReadReq) (*DatabaseResp, error)
...
func (UnimplementedCRUDServer) Create(context.Context, *UserWriteReq) (*DatabaseResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedCRUDServer) Read(context.Context, *UserReadReq) (*DatabaseResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Read not implemented")
}
func (UnimplementedCRUDServer) Update(context.Context, *UserWriteReq) (*DatabaseResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Update not implemented")
}
func (UnimplementedCRUDServer) Delete(context.Context, *UserReadReq) (*DatabaseResp, error) {
...
func _CRUD_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CRUDServer).Create(ctx, req.(*UserWriteReq))
	}
...
func _CRUD_Read_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CRUDServer).Read(ctx, req.(*UserReadReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CRUD_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CRUDServer).Update(ctx, req.(*UserWriteReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _CRUD_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CRUDServer).Delete(ctx, req.(*UserReadReq))
	}
	return interceptor(ctx, in, info, handler)
}
